...
const TOKEN_EXPIRATION_TIME = {
	...
	USER_ACCESS: 15 * MATHEMATICAL.SECONDS_IN_A_MINUTE, // 15 minutes
	USER_REFRESH_SHORT: MATHEMATICAL.SECONDS_IN_A_DAY, // 1 day
	USER_REFRESH_LONG: MATHEMATICAL.SECONDS_IN_A_DAY * 30, // 30 days (remember me)
	USER_FORGOT_PASSWORD: MATHEMATICAL.SECONDS_IN_A_MINUTE * 30 // 30 minutes
};
